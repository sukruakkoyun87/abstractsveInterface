...
public class QQHKPSPublicSoap
{
    ...
    public QQHKPSPublicSoap(){}

    public QQHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QQHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QQHExtendedSoapSerializationEnvelope envelope= new QQHExtendedSoapSerializationEnvelope(QQHExtendedSoapSerializationEnvelope.VER11);
